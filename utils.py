...
def reconstruct_gs(images, offset, target_resolution, n_iterations=3):
    """
    ...
    for i in range(n_iterations):
        ...
        for (idx, img) in images:
            ...
            sub_band = hr_spectrum[target_resolution//2 - img_len//2 - int(idx*offset):target_resolution//2 + img_len//2 - int(idx*offset)]
